 ...
 *
 *    - It will print "Hello there, Ducky", then MAKE SCHOOL IS AWESOME. Yep, I was right!
 *
 *
 ...
 *
 *    - No, uppercase will not run because it will catch() an error and print that error
 *      occured. Yep, I was right
 *
 ...
 *    run the code again.
 *
 *     - It will print "Hello there, Ducky" and then fail with an error. Yep, I was right!
 *
 *
    ...
    return new Promise(function(resolve, reject) {
        setTimeout(function() {
            if(typeof str === 'string'){
                ...
                reject("Input string must be of type string!");
            }
        }, 1000)
    })
}
